...
module.exports = function(channelId, message, token) {
  ...
  // console.log('https://slack.com/api/chat.postMessage?' + qs.encode(params));
  // return rp.get('https://slack.com/api/chat.postMessage?' + qs.encode(params));
  ...
  return rp.post(`https://slack.com/api/chat.postMessage?token=${token}`, options);
